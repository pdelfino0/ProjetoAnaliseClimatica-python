...
print(moda_um_relativa)
print(moda_vel_vento)
print(moda_temp_min)
'''
...
def busca_informacoes_auge_inverno():
    ...
    print(f"A média da velócidade do vento no mês de Junho durante a década de 2006 a 2016 foi de {media_vel_vento:2.1f}m/s, com moda de {float(moda_vel_vento):5.1f} m/s")
